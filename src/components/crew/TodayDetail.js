          ...
          {todayJobs.length > 0 ? (
            todayJobs.map((job) => (
              <div key={job.id} className='job-card'>
                <img class="job-map" src={`https://www.mapquestapi.com/staticmap/v5/map?key=SboTAEZ9t8caAhRqQ3GSGWNmmcCz1Ag8&locations=${job.location}&zoom=12`} alt="office-map-marker"></img>
